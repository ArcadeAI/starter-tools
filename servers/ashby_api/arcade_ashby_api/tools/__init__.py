...
async def get_api_key_info(
    context: ToolContext,
    empty_request_body: Annotated[
        dict[str, str] | None,
        "Provide an empty JSON object as the request body. This is required to make the call but should contain no data.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'apiKeyInfo'."]:
    """Retrieve information about the current API key in use.

    Call this tool to get details about the API key being used in the current request. Useful for verifying permissions and understanding usage context."""  # noqa: E501
    request_data: Any = empty_request_body
...
async def change_application_source(
    context: ToolContext,
    application_source_details: Annotated[
        dict[str, dict[str, str]] | None,
        "JSON object containing `applicationId` and `sourceId` to specify the application and its new source.",  # noqa: E501
    ] = None,
) -> Annotated[
    dict[str, Any], "Response from the API endpoint 'applicationChangeSource'."
]:
    """Change the source of an application in Ashby.

    This tool is used to change the source of an application in the Ashby system. It requires the `candidatesWrite` permission, ensuring that only authorized changes are made."""  # noqa: E501
    request_data: Any = application_source_details
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def change_application_stage(
    context: ToolContext,
    application_stage_change_details: Annotated[
        dict[str, dict[str, str | dict[str, str]] | dict[str, str]] | None,
        "A JSON object containing applicationId, interviewStageId, and optional archiveReasonId and archiveEmail details, to change the application stage.",  # noqa: E501
    ] = None,
) -> Annotated[
    dict[str, Any], "Response from the API endpoint 'applicationChangeStage'."
]:
    """Change the stage of a candidate's application.

    This tool changes the stage of an application in the hiring process. Requires appropriate permissions to execute."""  # noqa: E501
    request_data: Any = application_stage_change_details
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def create_job_application(
    ...
    job_application_data: Annotated[
        dict[str, dict[str, str]] | None,
        "JSON object containing candidateId, jobId, interviewPlanId, interviewStageId, sourceId, creditedToUserId, createdAt, and applicationHistory for the job application.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'applicationCreate'."]:
    """Create a job application for a candidate.

    This tool is used to create a new job application for a candidate, typically when sourcing them for a job posting. It is not intended for job board submissions, which should use a different endpoint. This tool requires 'candidatesWrite' permission for access."""  # noqa: E501
    request_data: Any = job_application_data
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def transfer_application_to_job(
    context: ToolContext,
    application_transfer_details: Annotated[
        dict[str, dict[str, str]] | None,
        "A JSON object containing the details for transferring an application, including `applicationId`, `jobId`, `interviewPlanId`, `interviewStageId`, and `startAutomaticActivities`.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'applicationTransfer'."]:
    """Transfer an application to a different job.

    Use this tool to move an applicant's application from one job posting to another within the Ashby system. Requires the `candidatesWrite` permission."""  # noqa: E501
    request_data: Any = application_transfer_details
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def update_application_status(
    context: ToolContext,
    application_update_payload: Annotated[
        dict[str, bool | dict[str, str]] | None,
        "JSON object containing applicationId, sourceId, creditedToUserId, createdAt, and sendNotifications to update application details. sendNotifications controls subscriber notifications.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'applicationUpdate'."]:
    """Updates the status or details of an application.

    Use this tool to update an application's status or details. Ensure you have the `candidatesWrite` permission. For custom field updates, use the `customFields.setValue` endpoint."""  # noqa: E501
    request_data: Any = application_update_payload
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def update_application_history(
    ...
    dict[str, Any], "Response from the API endpoint 'applicationUpdateHistory'."
]:
...
async def get_application_history(
    ...
    dict[str, Any], "Response from the API endpoint 'applicationListHistory'."
]:
...
async def get_candidate_criteria_evaluations(
    ...
    dict[str, Any],
    "Response from the API endpoint 'applicationListCriteriaEvaluations'.",
]:
    ...
    if mode == ToolMode.GET_REQUEST_SCHEMA:
        return {
            "request_body_schema": REQUEST_BODY_SCHEMAS[
                "GETCANDIDATECRITERIAEVALUATIONS"
            ],
            "instructions": (
                "Use the request_body_schema to construct a valid JSON object. "
                "Once you have populated the object following the schema "
...
async def list_application_feedback(
    ...
    dict[str, Any], "Response from the API endpoint 'applicationFeedbackList'."
]:
...
async def add_hiring_team_member(
    context: ToolContext,
    hiring_team_member_details: Annotated[
        dict[str, dict[str, str]] | None,
        "A JSON object containing 'applicationId', 'teamMemberId', and 'roleId'. These IDs specify the application, team member, and role for adding to the hiring team.",  # noqa: E501
    ] = None,
) -> Annotated[
    dict[str, Any], "Response from the API endpoint 'applicationaddhiringteammember'."
]:
    """Add a user to the hiring team for an application.

    Call this tool to add an Ashby user to the hiring team at the application level. Suitable for managing team members in the hiring process. Requires 'candidateWrite' permission."""  # noqa: E501
    request_data: Any = hiring_team_member_details
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def remove_hiring_team_member(
    context: ToolContext,
    hiring_team_removal_details: Annotated[
        dict[str, dict[str, str]] | None,
        "JSON object containing applicationId, teamMemberId, and roleId for the user to be removed.",  # noqa: E501
    ] = None,
) -> Annotated[
    dict[str, Any],
    "Response from the API endpoint 'applicationremovehiringteammember'.",
]:
    """Remove a user from the hiring team for an application.

    Use this tool to remove a specific Ashby user from the hiring team at the application level. Suitable for managing team changes or correcting errors in team assignments. Requires the 'candidateWrite' permission."""  # noqa: E501
    request_data: Any = hiring_team_removal_details
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def get_hiring_team_roles(
    ...
    dict[str, Any], "Response from the API endpoint 'applicationHiringTeamRoleList'."
]:
...
async def submit_application_feedback(
    ...
    dict[str, Any], "Response from the API endpoint 'applicationfeedbacksubmit'."
]:
...
async def update_approval_definition(
    ...
    dict[str, Any], "Response from the API endpoint 'approvalDefinitionUpdate'."
]:
...
async def add_completed_assessment_to_candidate(
    ...
    dict[str, Any],
    "Response from the API endpoint 'assessmentAddCompletedToCandidate'.",
]:
    ...
    if mode == ToolMode.GET_REQUEST_SCHEMA:
        return {
            "request_body_schema": REQUEST_BODY_SCHEMAS[
                "ADDCOMPLETEDASSESSMENTTOCANDIDATE"
            ],
            "instructions": (
                "Use the request_body_schema to construct a valid JSON object. "
                "Once you have populated the object following the schema "
...
async def list_candidate_client_info(
    ...
    dict[str, Any], "Response from the API endpoint 'candidateListClientInfo'."
]:
...
async def list_candidate_projects(
    ...
    dict[str, Any], "Response from the API endpoint 'candidateListProjects'."
]:
...
async def list_enabled_communication_templates(
    ...
    dict[str, Any], "Response from the API endpoint 'communicationTemplateList'."
]:
...
async def get_department_details(
    ...
    department_id: Annotated[
        dict[str, dict[str, str]] | None,
        "The ID of the department to fetch details for. This is required to retrieve accurate department information.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'departmentInfo'."]:
    """Fetches department details using a department ID.

    Use this tool to retrieve details about a specific department by providing its ID. This can be useful for obtaining departmental information when needed for organizational management. Requires appropriate permissions."""  # noqa: E501
    request_data: Any = department_id
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def get_feedback_form_info(
    ...
    dict[str, Any], "Response from the API endpoint 'feedbackFormDefinitionInfo'."
]:
...
async def list_feedback_forms(
    ...
    dict[str, Any], "Response from the API endpoint 'feedbackFormDefinitionList'."
]:
...
async def remove_team_member_from_hiring(
    ...
    dict[str, Any], "Response from the API endpoint 'hiringteamremovemember'."
]:
...
@tool(requires_secrets=["ASHBY_API_KEY"])
async def fetch_interview_details(
    context: ToolContext,
    interview_id: Annotated[
        dict[str, dict[str, str]] | None,
        "The unique ID of the interview to fetch details for. This ID is required to retrieve the specific interview information.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'interviewInfo'."]:
    """Retrieve interview details using interview ID.

    This tool fetches specific interview details by using the interview ID. Useful for retrieving comprehensive information about an interview when required."""  # noqa: E501
    request_data: Any = interview_id
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def cancel_interview_schedule(
    context: ToolContext,
    interview_schedule_cancel_details: Annotated[
        dict[str, bool | dict[str, str]] | None,
        "A JSON object containing the ID of the interview schedule to cancel and whether rescheduling is allowed. Required JSON structure with keys 'id' and 'allowReschedule'.",  # noqa: E501
    ] = None,
) -> Annotated[
    dict[str, Any], "Response from the API endpoint 'interviewScheduleCancel'."
]:
    """Cancel an interview schedule using its ID.

    Use this tool to cancel an existing interview schedule by providing its ID. Requires appropriate permissions."""  # noqa: E501
    request_data: Any = interview_schedule_cancel_details
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def create_interview_schedule(
    context: ToolContext,
    interview_schedule_request: Annotated[
        dict[
            str,
            dict[str, str]
            | list[dict[str, str | dict[str, str] | list[dict[str, bool | str]]]],
        ]
        | None,
        "JSON object containing application ID, interview events, and extra data. Events include start time, end time, and interviewers.",  # noqa: E501
    ] = None,
) -> Annotated[
    dict[str, Any], "Response from the API endpoint 'interviewScheduleCreate'."
]:
    """Create a scheduled interview in Ashby.

    Use this tool to create a new interview schedule in Ashby. This requires the `interviewsWrite` permission."""  # noqa: E501
    request_data: Any = interview_schedule_request
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def get_interview_schedules(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewScheduleList'."
]:
...
async def update_interview_schedule(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewScheduleUpdate'."
]:
...
async def fetch_interview_stage_details(
    context: ToolContext,
    interview_stage_id: Annotated[
        dict[str, dict[str, str]] | None,
        "The unique identifier of the interview stage to fetch details for. Required for retrieving the specific stage information.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'interviewStageInfo'."]:
    """Fetches details of a specific interview stage.

    Use this tool to fetch detailed information about a specific interview stage using its ID. Requires the 'interviewsRead' permission."""  # noqa: E501
    request_data: Any = interview_stage_id
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
...
async def list_interview_stage_groups(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewStageGroupList'."
]:
...
async def create_interviewer_pool(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewerPoolCreate'."
]:
...
async def update_interviewer_pool(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewerPoolUpdate'."
]:
...
async def archive_interviewer_pool(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewerPoolArchive'."
]:
...
async def restore_interviewer_pool(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewerPool.restore'."
]:
...
async def add_user_to_interviewer_pool(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewerPoolAddUser'."
]:
...
async def remove_user_from_interviewer_pool(
    ...
    dict[str, Any], "Response from the API endpoint 'interviewerPoolRemoveUser'."
]:
...
async def update_job_compensation(
    ...
    dict[str, Any], "Response from the API endpoint 'jobUpdateCompensation'."
]:
...
async def list_enabled_job_boards(
    ...
    request_body_data: Annotated[
        dict[str, str] | None,
        "The JSON payload for the request. This should contain any necessary parameters for listing enabled job boards.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'jobBoardList'."]:
    """Retrieve all enabled job boards.

    Use this tool to obtain a list of all job boards that are currently enabled. Useful for viewing or managing active job boards."""  # noqa: E501
...
async def job_interview_plan_info(
    ...
    dict[str, Any], "Response from the API endpoint 'jobInterviewPlanInfo'."
]:
...
async def update_location_address(
    ...
    dict[str, Any], "Response from the API endpoint 'locationupdateaddress'."
]:
...
async def update_location_remote_status(
    ...
    dict[str, Any], "Response from the API endpoint 'locationupdateremotestatus'."
]:
...
async def update_workplace_type(
    ...
    dict[str, Any], "Response from the API endpoint 'locationupdateworkplacetype'."
]:
...
async def remove_location_from_opening(
    ...
    dict[str, Any], "Response from the API endpoint 'openingremovelocation'."
]:
...
async def set_opening_state(
    ...
    dict[str, Any], "Response from the API endpoint 'openingsetopeningstate'."
]:
...
async def set_opening_archived_state(
    context: ToolContext,
    opening_id: Annotated[
        str | None, "The ID of the job opening to archive or unarchive."
    ] = None,
...
async def update_job_opening(
    ...
    department_team_id: Annotated[
        str | None,
        "The unique ID of the department or team associated with the job opening.",
    ] = None,
    employment_type: Annotated[
        str | None,
    ...
    opening_identifier: Annotated[
        str | None, "The unique ID of the job opening to update."
    ] = None,
    target_hire_date: Annotated[
        str | None,
        "The date in YYYY-MM-DD format by which you intend to hire for the opening.",
    ] = None,
    target_start_date: Annotated[
        str | None,
        "The intended start date (in YYYY-MM-DD format) for a newly hired employee.",
    ] = None,
...
async def list_source_tracking_links(
    ...
    dict[str, Any], "Response from the API endpoint 'sourcetrackinglinklist'."
]:
...
async def get_survey_form_details(
    ...
    dict[str, Any], "Response from the API endpoint 'surveyFormDefinitionInfo'."
]:
...
async def list_survey_form_definitions(
    ...
    dict[str, Any], "Response from the API endpoint 'surveyFormDefinitionList'."
]:
...
async def create_survey_submission(
    ...
    dict[str, Any], "Response from the API endpoint 'surveySubmissionCreate'."
]:
...
async def list_survey_submissions(
    ...
    dict[str, Any], "Response from the API endpoint 'surveySubmissionList'."
]:
...
async def get_interviewer_settings(
    ...
    dict[str, Any], "Response from the API endpoint 'userInterviewerSettings'."
]:
...
async def update_interviewer_settings(
    ...
    dict[str, Any], "Response from the API endpoint 'userUpdateInterviewerSettings'."
]:
...
async def create_webhook_setting(
    ...
    webhook_configuration: Annotated[
        dict[str, str] | None,
        "A JSON object containing configuration details for the webhook, including webhookType, requestUrl, and secretToken.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'webhookcreate'."]:
    """Creates a webhook setting in Ashby.

    Use this tool to set up a new webhook in Ashby. This action is necessary when you want to receive event notifications from Ashby. Make sure the required permissions are in place to perform this operation."""  # noqa: E501
...
@tool(requires_secrets=["ASHBY_API_KEY"])
async def update_webhook_setting(
    context: ToolContext,
    webhook_settings_payload: Annotated[
        dict[str, bool | str | dict[str, str]] | None,
        "JSON object containing `webhookId`, optionally one of `enabled`, `requestUrl`, or `secretToken` to update specific settings.",  # noqa: E501
    ] = None,
) -> Annotated[dict[str, Any], "Response from the API endpoint 'webhookupdate'."]:
    """Update a webhook setting for Ashby service.

    Use this tool to update specific webhook settings such as `enabled`, `requestUrl`, or `secretToken` in the Ashby service. Requires permission to write API keys."""  # noqa: E501
    request_data: Any = webhook_settings_payload
    if isinstance(request_data, dict):
        request_data = remove_none_values(request_data)
    content = json.dumps(request_data) if request_data else None
    response = await make_request(
